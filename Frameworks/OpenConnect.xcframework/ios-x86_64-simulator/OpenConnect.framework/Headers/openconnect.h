...
typedef void (*openconnect_os_setup_tun_vfn) (void *privdata);
void openconnect_set_os_setup_tun_handler(struct openconnect_info *vpninfo,
                                          openconnect_os_setup_tun_vfn os_setup_tun);

typedef int (*openconnect_os_read_tun_vfn) (struct pkt *pkt, void* privdata);
void openconnect_set_os_read_tun_handler(struct openconnect_info *vpninfo,
                                         openconnect_os_read_tun_vfn os_read_tun);
typedef int (*openconnect_os_write_tun_vfn) (struct pkt *pkt, void* privdata);
void openconnect_set_os_write_tun_handler(struct openconnect_info *vpninfo,
                                          openconnect_os_write_tun_vfn os_write_tun);
